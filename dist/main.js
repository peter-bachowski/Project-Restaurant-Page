...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  box-sizing: border-box;\n  font-family: \"Roboto\", sans-serif;\n}\n\nhtml, body, #container {\n  height: 100%;\n  min-width: 375px;\n  padding: 0;\n  margin: 0;\n  display: flex;\n  flex-direction: column;\n}\n\n.footer {\n  width: 100%;\n  background-color: #3b3430;\n  min-height: 250px;\n  display: flex;\n}\n\n#mainContent1 {\n  background-image: linear-gradient(rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.25)), url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n  background-size: 100% auto;\n  background-repeat: no-repeat;\n  color: #f4f4f4;\n}\n\n#mainContent2 {\n  height: 100%;\n  display: flex;\n}\n\n.navBar, .navMenu, .logoAndTitleCont {\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: center;\n  align-items: center;\n}\n\n.navBar {\n  justify-content: space-between;\n  padding-left: 70px;\n  padding-right: 70px;\n  padding-top: 20px;\n  align-items: center;\n}\n\n.navMenu {\n  justify-content: center;\n  gap: 30px;\n  font-size: 20px;\n}\n\na {\n  text-decoration: none;\n  color: inherit;\n}\n\n.pageTitle {\n  font-size: 20px;\n  font-weight: 700;\n  margin-right: 20px;\n}\n\n.logo {\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ");\n  background-size: 100%;\n  width: 50px;\n  height: 50px;\n}\n\n.logoAndTitleCont {\n  gap: 20px;\n}\n\n.gridContainer {\n  padding: 50px;\n  display: inline-grid;\n  grid-template-columns: repeat(auto-fill, minmax(250px, 1fr));\n  grid-gap: 10px;\n  width: 100%;\n  height: 100%;\n  justify-items: center;\n}\n\n.menuElement {\n  width: 250px;\n  height: 250px;\n  background-position: center;\n  background-size: 100%;\n}", "",{"version":3,"sources":["webpack://./src/styles/main.scss"],"names":[],"mappings":"AAUA;EACI,sBAAA;EACA,iCAAA;AARJ;;AAWA;EACI,YAAA;EACA,gBAAA;EACA,UAAA;EACA,SAAA;EACA,aAAA;EACA,sBAAA;AARJ;;AAWA;EACI,WAAA;EACA,yBAxBY;EAyBZ,iBAAA;EACA,aAAA;AARJ;;AAWA;EACI,oHAAA;EACA,0BAAA;EACA,4BAAA;EAEA,cAjCc;AAwBlB;;AAYA;EACI,YAAA;EACA,aAAA;AATJ;;AAYA;EACI,aAAA;EACA,eAAA;EACA,uBAAA;EACA,mBAAA;AATJ;;AAYA;EACI,8BAAA;EACA,kBA9CW;EA+CX,mBA/CW;EAgDX,iBAAA;EACA,mBAAA;AATJ;;AAYA;EACI,uBAAA;EACA,SAAA;EACA,eAAA;AATJ;;AAYA;EACI,qBAAA;EACA,cAAA;AATJ;;AAYA;EACI,eAAA;EACA,gBAAA;EACA,kBAAA;AATJ;;AAYA;EACI,yDAAA;EACA,qBAAA;EACA,WAAA;EACA,YAAA;AATJ;;AAYA;EACI,SAAA;AATJ;;AAYA;EACI,aAAA;EACA,oBAAA;EACA,4DAAA;EACA,cAAA;EACA,WAAA;EACA,YAAA;EACA,qBAAA;AATJ;;AAYA;EACI,YA1FgB;EA2FhB,aA3FgB;EA4FhB,2BAAA;EACA,qBAAA;AATJ","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Roboto&display=swap');\n\n$primary-color: #3b3430;\n$secondary-color: #f4f4f4;\n$box-shadow: 0 10px 20px rgba(0,0,0,0.1), 0 6px 6px rgba(0,0,0,0.1);\n$background-width: 100%;\n$content-height: 500px;\n$side-padding: 70px;\n$menuItemDimension: 250px;\n\n* {\n    box-sizing: border-box;\n    font-family: 'Roboto', sans-serif;\n}\n\nhtml, body, #container {\n    height: 100%;\n    min-width: 375px;\n    padding: 0;\n    margin: 0;\n    display: flex;\n    flex-direction: column;\n}\n\n.footer {\n    width: 100%;\n    background-color: $primary-color;\n    min-height: 250px;\n    display: flex;\n}\n\n#mainContent1 {\n    background-image: linear-gradient(rgb(0,0,0,0.25),rgb(0,0,0,0.25)), url(../assets/images/pizza-background.jpg);\n    background-size: $background-width auto;\n    background-repeat: no-repeat;\n    // min-height: 500px;\n    color: $secondary-color;\n}\n\n#mainContent2 {\n    height: 100%;\n    display: flex;\n}\n\n.navBar, .navMenu, .logoAndTitleCont {\n    display: flex;\n    flex-wrap: wrap;\n    justify-content: center;\n    align-items: center;\n}\n\n.navBar {\n    justify-content: space-between;\n    padding-left: $side-padding;\n    padding-right: $side-padding;\n    padding-top: $side-padding - 50px;\n    align-items: center;\n}\n\n.navMenu {\n    justify-content: center;\n    gap: 30px;\n    font-size: 20px;\n}\n\na {\n    text-decoration: none;\n    color: inherit;\n}\n\n.pageTitle {\n    font-size: 20px;\n    font-weight: 700;\n    margin-right: 20px;\n}\n\n.logo {\n    background-image: url('../assets/images/space-needle.png');\n    background-size: 100%;\n    width: 50px;\n    height: 50px;\n}\n\n.logoAndTitleCont {\n    gap: 20px;\n}\n\n.gridContainer {\n    padding: 50px;\n    display: inline-grid;\n    grid-template-columns: repeat(auto-fill, minmax(250px, 1fr));\n    grid-gap: 10px;\n    width: 100%;\n    height: 100%;\n    justify-items: center;\n}\n\n.menuElement {\n    width: $menuItemDimension;\n    height: $menuItemDimension;\n    background-position: center;\n    background-size: 100%;\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (makeHeaderElements);

/***/ }),

/***/ "./src/resizeContent.js":
/*!******************************!*\
  !*** ./src/resizeContent.js ***!
  \******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _makeGridForMenu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./makeGridForMenu */ "./src/makeGridForMenu.js");
...
(0,_makeGridForMenu__WEBPACK_IMPORTED_MODULE_4__["default"])();
